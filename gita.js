/* =========================================================
   ...
   Hindi + English + Gujarati Meaning
   ========================================================= */
...
async function loadGita(){
    ...
    try{
        ...
        /*
           Keep standard 700 verses.

           If source contains 701,
           remove the extra 13.1 edition
           and then keep 700.
        */
        ...
        try{
            ...
            console.log(
                "SANSKRITAM: Loading Hindi meanings..."
            );
